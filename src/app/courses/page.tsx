...
export default function Courses() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="relative bg-gradient-to-br from-teal-600 to-blue-700 py-20">
              ...
              >
                <div className="p-6">
                  ...
                  <button
                    ...
                    className="w-full bg-teal-600 text-white py-3 rounded-xl font-semibold hover:bg-teal-700 transition-colors duration-200"
                  >
                    Enroll Now
                  </button>
                </div>
      ...
      <section className="bg-teal-600 py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <button
            onClick={() => setIsLoginOpen(true)}
            className="bg-white text-teal-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-colors duration-200"
          >
            Get Started Today
          </button>
        </div>
